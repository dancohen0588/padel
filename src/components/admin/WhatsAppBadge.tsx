...
export function WhatsAppBadge({ hasJoined, joinedAt }: WhatsAppBadgeProps) {
  ...
  return (
    ...
    >
      <span
        className="inline-flex cursor-pointer items-center gap-1 rounded-full border border-green-400/30 bg-green-500/15 px-2.5 py-1 text-[11px] font-semibold text-green-300"
